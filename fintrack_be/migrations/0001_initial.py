# Generated by Django 3.0.7 on 2020-06-25 16:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timezone', models.CharField(default='BST', max_length=50)),
                ('opening_time', models.TimeField()),
                ('closing_time', models.TimeField()),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='country_exchanges', to='fintrack_be.Country')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='company_stocks', to='fintrack_be.Company')),
                ('exchange', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exchange_stocks', to='fintrack_be.Exchange')),
            ],
        ),
        migrations.CreateModel(
            name='StockPriceData',
            fields=[
                ...
                ('ml_prediction', models.CharField(choices=[('BUY', 'BUY'), ('SELL', 'SELL'), ('HOLD', 'HOLD')], default='HOLD', max_length=4)),
                ('stock', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stock_prices', to='fintrack_be.Stock')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instrument', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='position_instrument', to='fintrack_be.Stock')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, unique=True)),
                ('sector', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sector_industries', to='fintrack_be.Sector')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('change_perc', models.DecimalField(decimal_places=4, default=Decimal('0'), max_digits=15)),
                ('index', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='index_prices', to='fintrack_be.Index')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('constituent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fintrack_be.Stock')),
                ('index', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fintrack_be.Index')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='company',
            name='industry',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='industry_companies', to='fintrack_be.Industry'),
        ),
        migrations.AddField(
            model_name='user',
            name='country',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='fintrack_be.Country'),
        ),
        migrations.AddField(
            model_name='user',
            name='favourite_stocks',
            field=models.ManyToManyField(related_name='favourite_stock', to='fintrack_be.Stock'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['timestamp', 'stock'], name='fintrack_be_timesta_bea931_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='position',
            index=models.Index(fields=['id', 'instrument'], name='fintrack_be_id_82b954_idx'),
        ),
        migrations.AddIndex(
            model_name='indexpricedata',
            index=models.Index(fields=['timestamp', 'index'], name='fintrack_be_timesta_0f3677_idx'),
        ),
        migrations.AddConstraint(
            model_name='indexpricedata',
