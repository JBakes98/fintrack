# Generated by Django 3.0.7 on 2020-06-23 12:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ml_prediction', models.CharField(choices=[('BUY', 'BUY'), ('SELL', 'SELL'), ('HOLD', 'HOLD')], default=('HOLD', 'HOLD'), max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='fintrack_be.Country')),
                ('favourite_stocks', models.ManyToManyField(related_name='favourite_stock', to='fintrack_be.Stock')),
