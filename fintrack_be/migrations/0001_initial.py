    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='parent_company', to='fintrack_be.Company')),
                ('exchange', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listed_exchange', to='fintrack_be.Exchange')),
            ],
        ),
        migrations.CreateModel(
            name='StockPriceData',
            fields=[
                ...
                ('stock', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stock_data', to='fintrack_be.Stock')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, unique=True)),
                ('sector', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='industry_sector', to='fintrack_be.Sector')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('change_perc', models.DecimalField(decimal_places=4, default=Decimal('0'), max_digits=15)),
                ('index', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='index_data', to='fintrack_be.Index')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='company',
            name='industry',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='company_industry', to='fintrack_be.Industry'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
        ...
        migrations.AddIndex(
            model_name='position',
            index=models.Index(fields=['id', 'instrument'], name='position_id_96f0af_idx'),
        ),
        migrations.AddIndex(
